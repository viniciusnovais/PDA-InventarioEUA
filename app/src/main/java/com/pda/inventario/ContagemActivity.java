...
public class ContagemActivity extends Activity {
    ...
    private void setTituloTela() {
        try {
            switch (TIPO_ATIVIDADE) {
                case 2:
                    tvTitulo.setText("Count");
                    break;
                case 3:
                    tvTitulo.setText("Audit");
                    break;
                case 4:
                    tvTitulo.setText("Final Count");
                    break;
                case 5:
                    tvTitulo.setText("Divergence");
                    break;
                default:
                    break;
            }
    ...
    private void populaSpinnerMetodoContagem() {
        try {
            ...
            String[] values = new String[]{
                    "One by one",
                    "Multiple",
                    "One by one with verification",
                    "Multiple with verification"
            };
    ...
    private void validaContMult(final ProdutoEO prod) {
        try {
            if (etQuantidade.getText().toString().equals("") || Integer.parseInt(etQuantidade.getText().toString()) < 0) {
    ...
    private void contagemMult(ProdutoEO objProduto) {
        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            View view = View.inflate(ContagemActivity.this,R.layout.multiplos_novo, null);
